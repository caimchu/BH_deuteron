...
{
    const double mpro = 0.9389187;                           //   (proton mass + neutron mass )/2
...
namespace incidentPhoton
{
    ...
    double BremsstrahlungPhoton(TLorentzVector* q, const double kmin, const double kmax, const double E) 
    { //Generate a Bremsstrahlung photon ! Assume d / X0 = 0.01 radiator!
...
{
    const double Md = nuclearTensor::mdeu;
    const double Mp = nuclearTensor::mpro;
    ...
    void setModel(int lepType, double maxene)
    {
